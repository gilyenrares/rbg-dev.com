...
const Navigation = () => {
  ...
  return (
    <header className="w-full top-0 fixed z-10  bg-black/50 border-b-2 border-red-500 h-20">
      <nav className=' container mx-auto grid justify-between items-center text-xl  navbar--custom '>
