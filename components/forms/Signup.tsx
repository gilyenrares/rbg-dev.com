...
export default function Signup() {
  ...
  return (
    <form onSubmit={handleSubmit} className='form--custom my-10 p-10 justify-center mx-auto md:container container text-white'>
        ...
        <div className="border-b border-gray-900/10 pb-12">
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-3">
              <Select label="Select Project" name="selectProject" value={value ? value : projectsList[0].value} options={projectsList.map((project) => ({ value: project.value, label: project.option }))} onChange={(val) => { setValue(val)}} />
            </div>
            ...
            <div className="sm:col-span-3">
              ...
              <div className="mt-2">
                <div className="flex rounded h-14  bg-neutral-800 text-white border-red-500 border-b-2 p-4 my-4 w-full">
                  <span className="flex select-none items-center pl-3 text-white sm:text-sm">{value ? value : 'website.com'}/</span>
                  <input
                    type="text"
                    name="username"
                    id="username"
      ...
      <div className="mt-6 flex items-center justify-center sm:justify-end gap-x-6">
        <div className='grid grid-cols-1 sm:grid-cols-2'>
          ...
          <Button type='submit' name='sign-up-request' buttonStyle='btn--success' >{loading ? "Submitting..." : "Sign Up"}</Button>
        </div>
      </div>
    </form>
  )
