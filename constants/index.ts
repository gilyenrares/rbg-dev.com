...
export const maintenanceCards =[
  { 
    ...
    price: '20£/month',
    itemList: [
      {id: 3, isIncluded: true, name: 'Content upload'},
      {id: 6, isIncluded: true, name: 'Feature updates'},
      {id: 5, isIncluded: true, name: 'Software updates'},
      {id: 4, isIncluded: true, name: 'Web security'},
      {id: 2, isIncluded: true, name: 'Page speed'},
      {id:11, isIncluded: true, name: 'Website Revisions*'},
      {id:12, isIncluded: true, name: '*Any using exiting design (up to 5h work time) *'},
      {id:13, isIncluded: true, name: '2 Website updates**'},
      {id:14, isIncluded: true, name: '**(1-5)New sections'},
      {id:15, isIncluded: true, name: '**New page'},
      {id: 8, isIncluded: true, name: 'Hosting: Static Website'},
      {id: 9, isIncluded: true, name: 'Hosting: Dynamic Website'},
      {id:10, isIncluded: false, name: 'Hosting: Interactive Website'},
      {id: 7, isIncluded: false, name: 'Database maintenance'},
      {id: 1, isIncluded: false, name: 'SEO audit'},
    ],
    url: '/',
  },
  {
