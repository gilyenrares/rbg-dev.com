...
export const servicesCards =[
  { 
    ...
    price: '50£/each',
    itemList: [
      {id:1, isIncluded: true, name: 'Static header'},
      {id:2, isIncluded: true, name: 'Static Content Section'},
      {id:3, isIncluded: true, name: 'Static Carousel'},
      {id:4, isIncluded: true, name: 'Static Cards Section'},
      {id:5, isIncluded: false, name: 'Dynamic header'},
      {id:6, isIncluded: false, name: 'Dynamic Content Section'},
      {id:7, isIncluded: false, name: 'Dynamic Carousel'},
      {id:8, isIncluded: false, name: 'Dynamic Cards Section'},
      {id:9, isIncluded: false, name: 'Dynamic Info'},
    ],
    url: '/',
  },
  {
   ...
   display:'services',
    ...
    itemList: [
      ...
      {id:3, isIncluded: true, name: 'Static Carousel'},
      {id:4, isIncluded: true, name: 'Static Cards Section'},
      {id:5, isIncluded: true, name: 'Dynamic header'},
      {id:6, isIncluded: true, name: 'Dynamic Content Section'},
      {id:7, isIncluded: true, name: 'Dynamic Carousel'},
      {id:8, isIncluded: true, name: 'Dynamic Cards Section'},
      {id:9, isIncluded: true, name: 'Dynamic Info'},
    ],
