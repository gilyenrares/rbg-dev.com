<!-- Modal -->
<div class="modal fade" id="java-script" tabindex="-1" role="dialog" aria-labelledby="Java Script Title" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title section_title" id="Java Script Title">JavaScript</h5>
      ...
      <div class="modal-body">
          <div class="d-flex flex-column justify-content-center">
            ...
            <h1 class="section_title">Java Script</h1>
          </div>
          <section>
           <article>
