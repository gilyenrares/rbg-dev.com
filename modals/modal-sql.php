<!-- Modal -->
<div class="modal fade" id="sql" tabindex="-1" role="dialog" aria-labelledby="Sql Title" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title black-title" id="Sql Title">Sql</h5>
        <span type="button" class="close" data-dismiss="modal" aria-label="Close"
           aria-hidden="true">&times;</span>
      </div>
      <div class="modal-body border-bottom border-warning">
          <div class="row d-flex flex-column justify-content-center align-items-center">
            <div class="col-md-6"><img src="images/badge-sql.png" alt="Sql Badge"></div>
            <h1 class="text-dark">Sql</h1>
          </div>
          <section>
           <article>
