...
{setHeader();});initVideo();initGallery();initMenu();function setHeader()
...
{var gallery=$('.gallery_slider');gallery.owlCarousel({autoplay:true,loop:true,smartSpeed:1200,nav:false,dots:false,center:true,responsive:{0:{items:3},991:{items:5}}});}}});