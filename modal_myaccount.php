...
<div id="modalMyaccount" class="modal">
  <div class="modal-content modal_container animate">
    ...
    <div class="section_subtitle"><?php echo $_SESSION['userEmail'];?></div>
    <label for="name" class="text_highlight"><b>Full Name:</b></label>
    <div class="section_subtitle"><?php echo $_SESSION['fn'].' '.$_SESSION['ln'];?></div>
    <label for="phone" class="text_highlight"><b>Tel No:</b></label>
    <div class="section_subtitle"><?php echo $_SESSION['tel'];?></div>
    <label for="account" class="text_highlight"><b>Account Type:</b></label>
    <div class="section_subtitle"><?php echo $_SESSION['accType'];?></div>
    <label for="address" class="text_highlight"><b>Address:</b></label>
    <div class="section_subtitle"><?php echo $_SESSION['str'].'</br></br>'. $_SESSION['city']. '</br></br>'. $_SESSION['pcd'];?></div>
