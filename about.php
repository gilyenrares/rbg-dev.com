	...
	<div class="row shadow-lg p-3 mb-5 bg-white rounded">
		<div class="col-lg-8">
			<div class="container mb-5">
				...
				<div class="text-dark">RBG Development named after our founder <a href="" data-toggle="tooltip" title="(Rares Beniamin Gilyen)">R.B.G.</a> aims to offer a unique experience.</div>
				<div class="mt-5">
					...
					<div class="col">
						<div class="container d-flex flex-lg-row flex-column align-items-start justify-content-start">
							...
							<div class="box d-flex flex-column align-items-center justify-content-center">
	                   			...
	                   			<button type="button" data-toggle="modal" data-target="#html">Find out more</button>
	                		</div>
	            			...
	            			<div class="box d-flex flex-column align-items-center justify-content-center">
								...
								<button type="button" data-toggle="modal" data-target="#css">Find out more</button>
	                  		</div>
	            			...
	            			<div class="box d-flex flex-column align-items-center justify-content-center">
	                    		...
	                    		<button type="button" data-toggle="modal" data-target="#php">Find out more</button>
	                  		</div>
					...
					<div class="col">
						<div class="container d-flex flex-lg-row flex-column align-items-start justify-content-start">
	            			...
	            			<div class="box d-flex flex-column align-items-center justify-content-center">
	                    		...
	                    		<button type="button" data-toggle="modal" data-target="#jquery">Find out more</button>
	                  		</div>
	            			...
	            			<div class="box d-flex flex-column align-items-center justify-content-center">
	                    		...
	                    		<button type="button" data-toggle="modal" data-target="#wordpress">Find out more</button>
	                  		</div>
				            ...
				            <div class="box d-flex flex-column align-items-center justify-content-center">
				                ...
				                <button type="button" data-toggle="modal" data-target="#java-script">Find out more</button>
				            </div>
					...
					<div class="col">
						<div class="container d-flex flex-lg-row flex-column align-items-start justify-content-start">
	            			...
	            			<div class="box d-flex flex-column align-items-center justify-content-center">
	                    		...
	                    		<button type="button" data-toggle="modal" data-target="#sql">Find out more</button>
	                  		</div>
	            			<!-- Box -->
	            			<div class="box d-flex flex-column align-items-center justify-content-center">
	                    		<h3>Bootstrap</h3>
	                    		<div class="box_icon"><img src="images/badge-bootstrap.png" alt=""></div>
	                    		<button type="button" data-toggle="modal" data-target="#bootstrap">Find out more</button>
	                  		</div>
	                  		<!-- Box -->
	            			<div class="box d-flex flex-column align-items-center justify-content-center">
...
<!-- Team -->
<div class="container-fluid about-b-img">
	<div class="container padding-top">
		<div class="row">
			<div class="col-lg-6">
				<div class="container">
				<div class="red-subtitle">RBG Development presents</div>
				<div class="white-title">Our  Team</div>
				</div>
			</div>
		</div>
	...
	<!-- Team Member -->
		<div class="col-lg-4 pt-5 pb-5">
			<div class="team_item">
				<div class="team_image"><img src="images/img_admin.png" alt=""></div>
				<div class="team_panel d-flex flex-column align-items-center justify-content-center text-center">
				<div class="team_name"><a href="#">Cris U.</a></div>
...
<?php 
	...
	include 'modals/modal-java-script.php';
